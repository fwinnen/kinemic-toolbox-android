...
abstract class PublisherJsonListener {
    ...
    /**
     * Start the listener at a specified ip address.
     * The listener can be started again after it was stopped.
     * @param ip ip address like "127.0.0.1"
     */
    ...
    /**
     * Start the listener at 'localhost'.
     * The listener can be started again after it was stopped.
     */
    public void start() {
        start("localhost");
    ...
    /**
     * Stop the listener and all related resources.
     * The listener can be started again after it was stopped.
     */
    public void stop() {
        if (mIOThread != null) {
